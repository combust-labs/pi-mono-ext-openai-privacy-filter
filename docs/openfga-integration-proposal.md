...
- [x] Add metrics: PII entities detected, authorization decisions allowed/denied, OpenFGA latency histogram, fail-closed events (OTLP HTTP push to OTEL collector or Prometheus Pushgateway)
